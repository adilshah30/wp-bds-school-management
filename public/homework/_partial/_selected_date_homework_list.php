            ...
            <div class="homework-month-days-listing-wrap" id="left_homework_scroll">
                <?php for($i = 1; $i <= $daysInMonth; $i++): ?>
                    ...
                    <?php
                        ...
                        $get_homework = $wpdb->get_results("SELECT $homework_table.*, $subject_table.subject_name FROM $homework_table INNER JOIN $subject_table ON $homework_table.subject_id = $subject_table.id WHERE $homework_table.subject_id='".$_POST['subject_id']."' && $homework_table.date = '".$curent_row_date."'" );                                        
                        
                        //$get_homework = $wpdb->get_results("SELECT * FROM $homework_table INNER JOIN $subject_table ON $homework_table.subject_id = $subject_table.id WHERE $homework_table.session_id = '".$session_id."' && $homework_table.date = '".$curent_row_date."'" );
                        ?>
                        <?php if($day == $i): ?>
