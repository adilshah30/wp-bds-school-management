...
//
                    echo $query = " SELECT $table_student.id as stu_id, $table_student.full_name as stu_name, $table_student.file, $table_parent.id, $table_parent.status
                FROM $table_parent
        ...
        <?php if ($item->status == 2) echo "Accepted"; ?>
                    ...
                    <td>
                        ...
                        foreach ($family as $value) {
                            if (!empty($value->f_phone2)) {
                                $value->f_phone = $value->f_phone . ', ' . $value->f_phone2;
                            }
                            ?>
                            <div id="example-02">
        ...
        <?php } ?>
                    ...
                    <td><?= ucfirst($_SESSION['teacher_grade']); ?></td>
                    <td> 
                        <?php
                        ...
                        ?>
                        <a href="<?php bloginfo('url') ?>/bds-add-report/" class="roster_rc">Add </a>
                        <?php
                        ...
                        ?>
                        <br/>
                        <a href="<?php bloginfo('url') ?>/bds-add-report/?std_id=<?= $item->stu_id ?>" class="roster_rc">Edit</a>
                    </td>
                    <td class="td_mng">
